...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name wrangell-builder
	$(CONTAINER_TOOL) buildx use wrangell-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm wrangell-builder
	rm Dockerfile.cross
...
stop: ## Stop local Kubernetes cluster
	aqua exec ctlptl delete -f ./cluster.yaml
#! [kind]
